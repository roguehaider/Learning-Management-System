...
export class AdminCoursesComponent {
  ...
  showDeleteConfirm(event:Event, courseData: any): void {
  ...
  handleOk(): void {
    ...
    this.service.createCourse(this.newCourse).subscribe(
      (response) => {
        console.log("Course created successfully:", response);
        this.toastService.showToast("success", "Course Created Successfully!");
  ...
  navigateToCourseDetail(courseDetail: any): void {
    ...
    this.router.navigate([`/admin/course-detail/${courseName}`], {
  ...
  handleEditOk(courseData: any): void {
    this.service.updateCourse(this.newCourse, courseData._id).subscribe(
      (response) => {
        console.log("Course created successfully:", response);
        this.isVisible = false;
      },
